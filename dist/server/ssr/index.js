...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-DxPDuYbY.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-DDUZz_1C.js");
		return {
			get "ErrorBoundary"() {
...
//#endregion
export { useRouter as a, __exportAll as c, app_ssr_entry_default as default, handleSsr, usePathname as i, __toESM as l, require_jsx_runtime as n, require_react as o, getLayoutSegmentContext as r, __commonJSMin as s, require_react_dom as t };
