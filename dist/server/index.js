globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/LoggerDashboard-Bw7k0brA.js","assets/layout-segment-context-BEZ_xtd6.js"];
...
function getDraftSecret() {
	return "156706f4-d6c1-46f1-b1ab-7c6c9556e744";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d306c63f-3432-48a6-ba1e-06cb2e835ab1";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d306c63f-3432-48a6-ba1e-06cb2e835ab1") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d306c63f-3432-48a6-ba1e-06cb2e835ab1",
		rootBoundaryId
	});
}
/**
