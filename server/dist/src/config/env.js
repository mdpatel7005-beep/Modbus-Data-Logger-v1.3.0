...
const envSchema = z
    ...
    if (env.NODE_ENV === "production" && !env.SETTINGS_ENCRYPTION_KEY) {
        context.addIssue({
            code: "custom",
            message: "SETTINGS_ENCRYPTION_KEY is required to protect saved connection passwords",
...
export const env = {
    ...
    settingsEncryptionKey: parsed.data.SETTINGS_ENCRYPTION_KEY ?? parsed.data.JWT_SECRET,
