...
export type RegisterDataType = "bool" | "uint16" | "int16" | "uint32" | "int32" | "float32" | "float64";
...
export type SystemAlertDeliveryStatus = "not_configured" | "pending" | "sent" | "failed";
export type UserRole = "administrator" | "operator" | "viewer" | "diagnostic";
export type SubscriptionStatus = "unlicensed" | "trial" | "active" | "grace" | "expired";
...
export interface WhatsAppAlertSettings extends Omit<WhatsAppAlertSettingsInput, "accessToken"> {
